...
type PutScopesReqBody = helper.PutScopesReqBody[models.ClaudeEnterpriseScope]
type ScopeDetail = srvhelper.ScopeDetail[models.ClaudeEnterpriseScope, models.ClaudeEnterpriseScopeConfig]

// PutScopes creates or updates ClaudeEnterprise organization scopes.
