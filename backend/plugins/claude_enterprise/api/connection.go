...
// PostConnections creates a new Claude Enterprise connection.
...
func PatchConnection(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	...
	if err := (&models.ClaudeEnterpriseConnection{}).MergeFromRequest(connection, input.Body); err != nil {
...
func DeleteConnection(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	conn := &models.ClaudeEnterpriseConnection{}
...
func ListConnections(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
	var connections []models.ClaudeEnterpriseConnection
...
func validateConnection(connection *models.ClaudeEnterpriseConnection) errors.Error {
	if connection == nil {
		return errors.BadInput.New("connection is required")
	}
	if connection.AnalyticsApiKey == "" {
		return errors.BadInput.New("analyticsApiKey is required")
	}
	if connection.OrganizationId == "" {
		return errors.BadInput.New("organizationId is required")
	}
	return nil
}
